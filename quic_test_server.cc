...
#include <iostream>
#include "net/test_tool/crypto_test_utils_chromium.cc" //[NOVA] server_config
...
int main(int argc, char *argv[]) {
  ...
  //CryptoTestUtils::ProofSourceForTesting() "net/test_tool/crypto_test_utils_chromium.cc" //[NOVA] server_config
  net::tools::QuicServer server(CryptoTestUtils::ProofSourceForTesting(),config, supported_versions);
