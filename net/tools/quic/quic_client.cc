...
QuicClient::QuicClient(IPEndPoint server_address,
    ...
    : /*QuicClientBase(server_id,
      ...
      server_id_(server_id),//[NOVA]
      local_port_(0),
      epoll_server_(epoll_server),
      fd_(-1),
      helper_(new QuicEpollConnectionHelper(epoll_server_)),//quic_toy中版本修改此位置的初始化方式
      initialized_(false),
      packets_dropped_(0),
      overflow_supported_(false),
      supported_versions_(supported_versions),//[NOVA]
      crypto_config_(proof_verifier),//[NOVA]
