...
//#include "net/tools/balsa/balsa_headers.h"//http头相关部分 quic_toy测试不使用
#include "net/tools/epoll_server/epoll_server.h"
//#include "net/tools/quic/quic_client_base.h"
//quic_client_base使用
#include "net/tools/quic/quic_client_session.h" //session_使用
#include "net/quic/quic_connection.h"   //
#include "net/quic/quic_protocol.h" //supported_versions
#include "net/quic/quic_packet_writer.h"//writer_
namespace net {
...
//  void SendRequestsAndWaitForResponse(const std::vector<std::string>& url_list);
  ...
  //quic_client_base中定义的继承部分内容[NOVA]
 ...
 private:
  ...
  //quic_client_base中定义的继承部分内容[NOVA]
  // Session which manages streams. //[NOVA]
